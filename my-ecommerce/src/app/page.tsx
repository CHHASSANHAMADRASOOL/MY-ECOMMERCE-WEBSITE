...
const sliderImages = [
  "https://scontent.flhe2-2.fna.fbcdn.net/v/t39.30808-6/486226397_1144459964145934_7346509992042338468_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=7b2446&_nc_ohc=jtKz6uP1Iy0Q7kNvwGDN3kD&_nc_oc=AdkeoT0wcVFgDhiJIDkuPy1HCHJDpfui11rKnhPUzBa4V6Nv6lVz6BYOKy2KClzBLt8&_nc_zt=23&_nc_ht=scontent.flhe2-2.fna&_nc_gid=FF0xbwEkESRQOEhMBsDpUQ&_nc_ss=8&oh=00_AfsH5PXX1UuGuXLmW_BuYmoR2XQSb1L7MK4Qt4wqY-djtw&oe=69A9F9AE",
...
export default function HomePage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev === sliderImages.length - 100 ? 0 : prev + 1));
    }, 3000);
      ...
      <header className="relative pt-20 pb-12 px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className="inline-block px-4 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-black uppercase tracking-[0.2em] mb-6 animate-bounce">
            New Life Collection of 2026 🚀
          </div>
          
          <h1 className="text-6xl md:text-8xl font-red tracking-tighter leading-[0.9] mb-8">
          luxery  LEVEL UP YOUR <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 italic"> luxery LIFERIDE.</span>
          </h1>
          ...
          <p className="max-w-xl text-gray-500 font-high text-lg mt-10 italic">
